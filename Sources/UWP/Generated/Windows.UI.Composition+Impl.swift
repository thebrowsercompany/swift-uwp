...
public enum __IMPL_Windows_UI_Composition {
    ...
    public enum IVisualElementBridge : AbiInterfaceBridge {
        ...
        public typealias SwiftABI = __ABI_Windows_UI_Composition.IVisualElement
        ...
        public static func makeAbi() -> CABI {
            let vtblPtr = withUnsafeMutablePointer(to: &__ABI_Windows_UI_Composition.IVisualElementVTable) { $0 }
            return .init(lpVtbl: vtblPtr)
        }
    }
